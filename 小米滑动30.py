...
for i in range(0, 166):
    # os.system('adb -s 79e8d0f8 shell input tap 528 2100')
    # os.system('adb -s 79e8d0f8 shell input tap 528 1788')
    os.system('adb -s 79e8d0f8 shell input tap 911 1259')
    # os.system('adb -s 79e8d0f8 shell input tap 501 1459')
    ...
    # 倒数第二排
    # os.system('adb -s 79e8d0f8 shell input tap 213 2109')
